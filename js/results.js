...
function initMap() {
    map = L.map('map').setView([25.034030, 121.563900], 9);
...
async function loadData() {
    try {
        ...
        const referendumResponse = await fetch('data/referendum_cunli_data.json');
        ...
        const geoResponse = await fetch('data/20250620.json');
